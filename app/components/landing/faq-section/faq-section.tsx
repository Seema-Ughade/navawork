          ...
          <div className="lg:col-span-1">
            <div className="lg:max-w-[320px] w-full border-[0.6px] border-[#D3D3D3] rounded-[8px] p-6 bg-white top-6">
              ...
              <div className="flex flex-col gap-3 lg:gap-6">
                                 <a href="https://cal.com/navawork/30min" target="_blank" rel="noopener noreferrer" className="w-full bg-[#1B1B1B] text-[12px] lg:text-[18px] text-white lg:h-[56px] h-[32px] w-[240px] rounded-full font-medium flex items-center justify-center gap-2 ">
              ...
              {faqItems.map((item) => (
                ...
                >
                  ...
                  >
                    ...
                    <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg" className={`flex-shrink-0 w-[12px] h-[7px] lg:w-[15px] lg:h-[9px] transition-transform duration-300 ${ openItems[item.id] ? "rotate-180" : "" }`} onClick={() => toggleFAQ(item.id)}  > <path d="M7.0677 8.47899L0 0.99759L0.942427 0L7.0677 6.48381L13.193 0L14.1354 0.99759L7.0677 8.47899Z" fill="#1C1B1F" /> </svg> </div>
