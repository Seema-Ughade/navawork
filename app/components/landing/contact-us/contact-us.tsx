...
export default function ContactUsPage() {
  return (
    <div className="relative lg:w-[1440px] md:w-full sm:w-[412px] mx-auto min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative z-10 lg:max-w-[1188px] mx-auto px-4 sm:px-6 lg:px-8 py-2 lg:mb-8 mb-0 lg:py-16">
