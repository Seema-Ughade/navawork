...
export function Hero() {
  return (
    <section className="relative mx-auto w-full sm:w-[412px] lg:w-[1440px] lg:mt-0 mt-2 lg:min-h-[580px] flex flex-col items-center justify-center overflow-hidden dark:bg-[#0a0a0a]  lg:pt-0 pt-4 pb-2">
      <HeroBackground />
