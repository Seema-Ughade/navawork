...
export function Hero() {
  return (
    <section className="relative mx-auto w-[1440px] lg:mt-0 mt-2 lg:min-h-[580px] flex flex-col items-center justify-center overflow-hidden dark:bg-[#0a0a0a]  lg:pt-0 pt-4 pb-2">
      <HeroBackground />
      <div className="relative z-10 w-[1440px] mx-auto px-4 sm:px-6 lg:px-0 text-center">
        {/* Badge */}
        ...
        {/* Features Row */}
        <div className="w-full lg:max-w-[1127px] lg:px-2 px-8 mx-auto grid grid-cols-2 md:grid-cols-4 gap-[25px] mt-1 mb-2">
          {[
            {
              icon: (
